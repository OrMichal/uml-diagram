...
public class UIDiamond : IComponent
{
    ...
    public UIDiamond(PointF location, SizeF size, Direction direction)
    {
        this.Size = size;
        ...
        if (Filled)
        {
            switch (Direction)
            {
                case Direction.Up:
                    ...
                    {
                        Location,
                        new PointF(Location.X + Size.Width / 2, Location.Y + Size.Height/2),
